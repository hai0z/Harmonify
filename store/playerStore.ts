...
interface PlayerStore {
  ...
  nextTrackLoaded: boolean;
  setNextTrackLoaded: (nextTrackLoaded: boolean) => void;
  isBlur: boolean;
...
export const usePlayerStore = create<PlayerStore>()(
  persist(
    set => ({
      ...
      imageQuality: 'medium',
      setImageQuality: (imageQuality: 'low' | 'medium' | 'high') =>
        set({imageQuality}),
      saveHistory: true,
      ...
      setNextTrackLoaded: (nextTrackLoaded: boolean) => set({nextTrackLoaded}),
      isBlur: false,
