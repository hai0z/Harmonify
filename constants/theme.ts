...
const headerGradientSunset = {
  MORNING: tinycolor("#ff9a9e").lighten(10).toString(),
  AFTERNOON: tinycolor("#fad0c4").lighten(5).toString(),
  EVENING: tinycolor("#ffecd2").toString(),
};
